...
const Navbar = () => {
  ...
  return (
    <div className="navbar relative overflow-visible z-30">
      {" "}
      {/* ADDED z-30 and overflow-visible */}
      <div className="navbar-start">
        <div className="dropdown relative z-50">
          {" "}
          {/* FIXED: added relative z-50 */}
      ...
      <motion.div
        ...
        className="navbar-end mr-2 md:mr-0 flex items-center gap-1 md:gap-6 relative z-50"
      >
        {user && (
